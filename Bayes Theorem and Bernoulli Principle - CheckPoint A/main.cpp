...
/**
 std::cout << "\nMultiSpam: " << std::endl;
 for(std::vector<std::string>::size_type i = 0; i < Spam.size(); i++)
 {
     for(std::vector<std::string>::size_type x = 0; x < Spam[i][0].size(); x++)
     {
     std::cout << Spam[i][0][x];
     }
 std::cout << std::endl;
 ...
 std::cout << "\nMultiHam: " << std::endl;
for(std::vector<std::string>::size_type i = 0; i < Ham.size(); i++)
{
    for(std::vector<std::string>::size_type x = 0; x < Ham[i][0].size(); x++)
    {
        std::cout << Ham[i][0][x];
    }
 ...
 std::cout << "\nSpamDocument: " << std::endl;
 for(std::vector<std::string>::size_type i = 0; i < SpamDocument.size(); i++)
 {
     for(std::vector<std::string>::size_type x = 0; x < SpamDocument[i][0].size(); x++)
     {
     std::cout << SpamDocument[i][0][x];
     }
 std::cout << std::endl;
 }
 
 std::cout << "\nHam Document: " << std::endl;
for(std::vector<std::string>::size_type i = 0; i < HamDocument.size(); i++)
{
    for(std::vector<std::string>::size_type x = 0; x < HamDocument[i][0].size(); x++)
    {
        std::cout << HamDocument[i][0][x];
    }
 ...
 std::cout << "\nSpam Words: " << std::endl;
 for(std::vector<std::string>::size_type i = 0; i < SpamWords.size(); i++)
     std::cout << SpamWords[i] << ' ';
     
     std::cout << "\nHam Words: " << std::endl;
     for(std::vector<std::string>::size_type i = 0; i < HamWords.size(); i++)
         std::cout << HamWords[i] << ' ';
 
 std::cout << "\nSpam Fraction: " << std::endl;
 for(std::vector<std::string>::size_type i = 0; i < SpamWords.size(); i++)
     std::cout << SpamFraction[i] << ' ';
     
     std::cout << "\nHam Fraction: " << std::endl;
     for(std::vector<std::string>::size_type i = 0; i < HamWords.size(); i++)
         std::cout << HamFraction[i] << ' ';
     command::space(2);
 
 std::cout << "\nBinary Vector: " << std::endl;
for(std::vector<std::string>::size_type i = 0; i < BinaryVector.size(); i++)
{
    for(std::vector<std::string>::size_type x = 0; x < BinaryVector[i][0].size(); x++)
    {
        std::cout << BinaryVector[i][0][x];
    }
 ...
 for(int i = 0; i < SpamFraction.size(); i++)
 {
     SpamArray[i] = SpamFraction[i];
     std::cout << "SpamArray[i].GetNumerator(): " << SpamArray[i].GetNumerator() << " SpamArray[i].GetDemoniator(): " << SpamArray[i].GetDenominator() <<"     SpamFraction[" << i << "]: " << SpamFraction[i] << std::endl;
 ...
 for(int i = 0; i < HamFraction.size(); i++)
 {
     HamArray[i] = HamFraction[i];
     std::cout << "HamArray[i].GetNumerator(): " << HamArray[i].GetNumerator() << " HamArray[i].GetDemoniator(): " << HamArray[i].GetDenominator() <<"     HamArray[" << i << "]: " << HamFraction[i] << std::endl;
 ...
 for(std::vector<std::string>::size_type i = 0; i < SpamFraction.size(); i++)
 {
     if(StringToInt(BinaryVector[0][0][i]) * (ConvertNumerator(SpamFraction[i]) / ConvertDenominator(SpamFraction[i]) == 0))
     {
        numerator = ConvertDenominator(SpamFraction[i]) - ConvertNumerator(SpamFraction[i]);
        B1.push_back(std::to_string(numerator) + '/' + std::to_string(ConvertDenominator(SpamFraction[i])));
        numerator = 0;
     }
     else
         B1.push_back(SpamFraction[i]);
 }
 
 
 for(int i = 0; i < b1Spam.size(); i++)
     std::cout << b1Spam[i] << ' ';
 command::space(2);
 
 for(int i = 0; i < b1Ham.size(); i++)
     std::cout << b1Ham[i] << ' ';
 command::space(2);
 
 for(int i = 0; i < b2Spam.size(); i++)
     std::cout << b2Spam[i] << ' ';
 command::space(2);
 
 for(int i = 0; i < b2Ham.size(); i++)
     std::cout << b2Ham[i] << ' ';
 command::space(2);
