...
//--------------------------------------------------------------
//Process contains each individual menu option
int Process(int menu, LinkedList* VendingMachine)
{
    ...
    case 1:
    {
        //Allows user to input variables through the linked list.
...
int main()
{
    //'Menu' represents each menu option the user chooses to select. the variable,
    int menu=0;
    
    //Object of Link List. The user will have the ability to add,delete and view all the stored information.
  ...
  while(menu!=4)
  {
        ...
        //Implements data within linked list
