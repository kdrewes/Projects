...
//--------------------------------------------------------------
//Inserts item
Node*LinkedList::Insert(Node*node,std::string title,int num, double wholesale, double gross_profit, double net_profit, double amount,bool wholesaleBool)
{
    
    if(node==NULL)
    {
        node=new Node(title,num,wholesale,gross_profit,net_profit,amount,wholesaleBool);
        this->head=node;
        this->tail=node;
        this->size++;
    }
    ...
    {
        Node *NewNode = new Node(title,num,wholesale,gross_profit,net_profit,amount,wholesaleBool);
